...
@section('content')
            ...
            <div class="page-header">
                ...
                <div class="ml-auto pageheader-btn">
                    <a href="{{ route('employees.create') }}" class="btn btn-primary btn-icon text-white mr-2">
									<span>
                            ...
                            <div class="table-responsive">
                                <table id="data-table1" class="table table-striped table-bordered text-nowrap w-100">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $user->email }}</td>
                                        <td>
                                            <a href="{{route('employees.edit',$user->id)}}" data-toggle="tooltip" data-placement="top" title="Edit User" class="btn btn-icon  btn-primary"><i class="fe fe-edit"></i></a>
                                                <a type="button" class="btn btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="Delete Record" id="confirm" data-delete-url="{{url('employees/delete/'.$user->id)}}">
