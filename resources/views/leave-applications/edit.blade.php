...
@section('content')
    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{'/leave-types'}}">Leave Type</a></li>
        ...
        <div class="col-lg-12">
            ...
            <div class="card accordion-wizard">
                <div class="card-header">
                    <h3 class="card-title">Leave Type Edit FORM</h3>
                </div>
                <div class="card-body">
                    {!! Form::model($leaveType, ['method' => 'PATCH','route' => ['leave-types.update', $leaveType->id]]) !!}
                    <div class="row">
