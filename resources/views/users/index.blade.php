...
@section('content')
            ...
            <div class="page-header">
                ...
                <div class="ml-auto pageheader-btn">
                    <a href="{{ route('users.create') }}" class="btn btn-primary btn-icon text-white mr-2">
									<span>
                            ...
                            <div class="table-responsive">
                                <table id="data-table1" class="table table-striped table-bordered text-nowrap w-100">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @canEdit($user)
                                            <a href="{{route('users.edit',$user->id)}}" data-toggle="tooltip" data-placement="top" title="Edit User" class="btn btn-icon  btn-primary"><i class="fe fe-edit"></i></a>
                                            @endcan
                                                @can('user-delete')
                                                <a type="button" class="btn btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="Delete Record" id="confirm" data-delete-url="{{url('users/delete/'.$user->id)}}">
                                                    <i class="fe fe-trash"></i></a>
                                                @endcan
                                            <a href="{{route('users.getUserAttendanceForCurrentMonth',$user->id)}}" data-toggle="tooltip" data-placement="top" title="User Attendance" class="btn btn-icon  btn-warning"><i class="fe fe-activity"></i></a>
                                            <a href="{{route('user-leaves',$user->id)}}" data-toggle="tooltip" data-placement="top" title="User Leaves" class="btn btn-icon  btn-info"><i class="fe fe-user"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
