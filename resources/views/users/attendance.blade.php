...
@section('content')
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">Users Attendance</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('users')}}">Users Attendance</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="alert alert-warning">
                                <p>Total Working Hours of this Month:{{ $totalWorkingHours }}</p>
                            </div>
